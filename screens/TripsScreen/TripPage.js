  ...
  return (
    ...
    >
      <View style={{ gap: 20, paddingBottom: 0, flex: 1 }}>
        ...
        <View style={{ flex: 1 }}>
          {Get_All_trip_data?.trips?.length > 0 ? (
            <ScrollView
              refreshControl={
            ...
            >
              {Get_All_trip_data?.trips.map((item) => (
                <Pressable
                  onPress={() => navigation.navigate("Tripsdetails", { item })}
                  style={{
                    borderWidth: 0.5,
                    borderRadius: 10,
                    marginVertical: 10,
                ...
                >
                  ...
                  >
                    ...
                    <View>
                      <Text style={{ lineHeight: 21.04 }}>
                        {formatDate(item?.routeId?.departureDate)}
